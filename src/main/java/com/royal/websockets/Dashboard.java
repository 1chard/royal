...
public class Dashboard {
	...
	@OnError
	public void deuMerda(Session s, Throwable t, @PathParam("token") String token) {
	...
	@OnMessage
	public void mensagem(String mensagem, Session s, @PathParam("token") String token) throws SQLException {
